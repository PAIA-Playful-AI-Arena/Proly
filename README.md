...
[![Windows](https://custom-icon-badges.demolab.com/badge/Windows-1.3.0-blue?logo=windows)](https://github.com/PAIA-Playful-AI-Arena/Proly/releases/download/1.3.0/Proly-win32-1.3.0.zip)
[![macOS](https://img.shields.io/badge/macOS-1.3.0-red?logo=apple)](https://github.com/PAIA-Playful-AI-Arena/Proly/releases/download/1.3.0/Proly-darwin-universal-1.3.0.zip)
[![Linux](https://img.shields.io/badge/Linux-1.3.0-green?logo=linux)](https://github.com/PAIA-Playful-AI-Arena/Proly/releases/download/1.3.0/Proly-linux-1.3.0.zip)
